    ...
    <form onSubmit={handleSubmit} className="grid grid-cols-12 gap-6">
      ...
      <div className="col-span-12">
        ...
        <textarea
          ...
          className="flex min-h-[100px] w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:cursor-not-allowed disabled:opacity-50 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100"
