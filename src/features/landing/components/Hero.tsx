...
export function Hero({ profile }: { profile: Profile | null }) {
  return (
    <header
      id="home"
      className="bg-gradient-primary relative flex min-h-screen flex-col items-center justify-center overflow-hidden py-[100px] dark:bg-[#020817]"
    >
      <div className="container mx-auto px-4">
        <div className="mx-auto w-full text-center md:w-10/12">
          <div className="mb-6 flex justify-center">
            <Image
              src={profile?.avatar_url || siteConfig.ogImage || "/me-2.webp"}
              alt={profile?.full_name || siteConfig.author}
              width={150}
              height={150}
          ...
          <h1 className="mb-5 text-[22px] leading-[1.2] md:text-[36px] lg:text-[55px] dark:text-white">
            {profile?.headline || "Front-End Developer"} —
            <span className="mx-2 block animate-[move-bg_20s_linear_infinite] bg-linear-to-r from-[rgb(50,66,74)] via-[rgb(69,134,255)] to-[rgb(50,66,74)] bg-size-[300%_100%] bg-clip-text text-transparent sm:inline">
              Every Pixel Matters.
            </span>
          </h1>
