      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {projects.map((project: Project) => (
            ...
            >
              <div className="aspect-video w-full bg-gray-100 dark:bg-gray-800 relative flex items-center justify-center overflow-hidden">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-[#32424a] dark:text-white mb-2 group-hover:text-[#1e282d] dark:group-hover:text-blue-400 transition-colors">
                  {project.title}
                </h3>
